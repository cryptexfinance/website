      ...
      <section id="about" className="section-about">
            ...
            <div className="about-details">
              <div className="about-details-item">
                <Link to="https://docs.google.com/document/d/14dFpXqlzrFqUbG7RFWcyP5z-4VTeUFMNyKo81nbYySQ/edit" rel="noreferrer" target="_blank" className="about-details-text"><img src={whitepaper} className="about-details-icons" alt="Whitepaper" />Whitepaper</Link>
              </div>
              ...
              <div className="about-details-divisor"></div>
              <div className="about-details-item">
                <Link to="https://docs.chain.link/docs/get-the-latest-price" rel="noreferrer" target="_blank" className="about-details-text"><img src={audit} className="about-details-icons" alt="Audit" />Audit</Link>
              </div>
            </div>
      </section>
  )
